  ...
  return (
    <>
      <section className="relative pt-44 z-1 pb-20 dark:bg-dark dark:bg-darkmode">
        <div className="w-full h-full absolute -z-1 bg-hero-bg rounded-b-[119px] -left-40 top-0 dark:bg-search"></div>
        ...
        <div className="container lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) mx-auto px-4">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4">
              <div className="z-20 mb-16 h-150 overflow-hidden rounded-sm ">
                <Image
                  src={post.coverImage}
                  alt="image"
                  width={1170}
                  ...
                  <div>
                    <div className="-mx-4 mb-8 flex flex-col">
                      <div className="w-full py-12 px-11 bg-white dark:bg-dark_b shadow-lg border-b-2 border-border dark:border-dark_border rounded-t-lg">
                        <h2 className="relative mb-5 text-2xl dark:text-white text-black font-medium sm:text-3xl" >
                          Share
                        </h2>
                      ...
                      <div className="w-full py-12 px-11 bg-white dark:bg-dark_b shadow-lg rounded-b-lg">
                        <p className="text-2xl sm:text-3xl font-medium mb-4">Join our Newsletter</p>
                        <input
                        ...
                        />
                        <button className="bg-primary w-full px-7 border text-base text-white border-primary py-4 rounded-lg hover:bg-transparent hover:text-primary">
                          Subscribe
                        </button>
                      </div>
                    </div>
