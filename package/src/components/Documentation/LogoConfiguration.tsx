export const LogoConfiguration = () => {
  return (
    <>
      ...
      <div className="p-6 rounded-lg border mt-4 border-border dark:border-dark_border">
        <p className="text-base font-medium text-midnight_text dark:text-white/60 flex lg:flex-row flex-col">
          1. Change Logo over here :
          <span className="font-semibold text-base overflow-x-auto">
            src/components/Layout/Header/Logo/index.tsx
          </span>
        </p>
        <div className="py-4 px-3 rounded-lg bg-black mt-8">
