...
export const PackageStructure = () => {
  ...
  return (
    <div id="structure" className="md:scroll-m-[130px] scroll-m-28">
      ...
      <div className="rounded-lg p-6 pt-3 border border-border dark:border-dark_border mt-6">
        <div className="flex items-center gap-4">
          <h5 className="text-base font-medium mt-3 mb-1">
            pi Tailwind Nextjs Templates
          </h5>
        </div>
        <ul className="ps-0 md:ps-5 list-unstyled">
          <li className="py-2">
            <div className="flex items-center gap-3">
              <p className="text-xl text-black dark:text-white/60">
                |—
              </p>
              <span className="font-medium text-midnight_text dark:text-white/60">
                <Icon
                  icon="tabler:folder"
                          ...
                          <ul className="ps-5 md:ps-12 list-unstyled">
                                ...
                                <ul className="ps-5 md:ps-12 list-unstyled red">
                                  <li className="py-2">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <span className="fs-9 text-midnight_text dark:text-white/60 ms-4">
                                        ...
                                        {Counts.slice(0, 10).map(
                                          (item, index) => {
                                            return (
                                              <p
                                                key={index}
                                                className="text-xl text-black dark:text-white/60"
                                              >
                                                |
                                              </p>
                                            );
                                        ...
                                        <li className="py-2">
                                          <div className="flex items-center gap-8">
                                            ...
                                            <div className="flex items-center gap-3">
                                              ...
                                              <span className="font-medium text-midnight_text dark:text-white/60 flex items-center flex-wrap">
                                                <Icon
                                                  icon="tabler:folder"
                                                  className="text-primary text-base inline-block me-2"
                                                />
                            ...
                            <li className="py-2">
                              <div className="flex items-center flex-wrap gap-3">
                                ...
                                <span className="fs-9 text-midnight_text ms-4 dark:text-white/60">
