    ...
    <>
      <div className="flex gap-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-border hover:bg-hero-bg p-3.5 duration-200 ease-in dark:border-dark_border dark:text-white dark:hover:bg-primary/20 hover:bg-primary/20 cursor-pointer"
        >
          Sign In
          <svg
            width="23"
